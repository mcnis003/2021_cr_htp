...
# setwd("/Users/ianmcnish/Google Drive File Stream/My Drive/projects/2017_btn/working_photos/btn_2018_06_11_flight_1_120ft/")

data <- read.csv("combined_control_panel_results.csv", header = FALSE)
